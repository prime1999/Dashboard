		...
		<>
			<div className="bg-white rounded-lg border border-stroke p-4 w-full dark:bg-transparent md:w-1/2">
				...
				<div className="mt-4">
					...
					<p className="font-plus font-semibold text-2xl">$350.000</p>
					<div className="flex justify-between mt-4">
						<span
							style={{ backgroundColor: "rgba(52, 202, 165, 0.12)" }}
						...
						>
							...
							<p className="font-plus font-medium text-xs text-green ml-2">
								23.5%
							</p>
						</span>
