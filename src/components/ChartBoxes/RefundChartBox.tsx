const RefundChartBox = () => {
	return (
		<>
			<div className="bg-white rounded-lg mb-2 border border-stroke p-4 w-full dark:bg-transparent md:mb-0 md:w-1/2">
				...
				<div className="mt-4">
					...
					<p className="font-plus font-semibold text-2xl">270</p>
