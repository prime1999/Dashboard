	...
	return (
		<>
			<div className="bg-white rounded-lg border border-stroke p-4 w-full dark:border-darkStroke dark:bg-darkBg md:w-1/2">
				...
				<div className="mt-4">
					<h4 className="font-plus text-lg font-medium text-[#898989]">
						Average Sales
					</h4>
					<p className="font-plus font-semibold text-2xl">1567</p>
					<div className="flex justify-between mt-4">
						<span
							style={{ backgroundColor: "rgba(237, 84, 78, 0.12)" }}
							className="flex items-center bg-[rgba(52, 202, 165, 0.12)] px-2 py-1 rounded-2xl"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="10"
							...
							<p className="font-plus font-medium text-xs text-red ml-2">
								23.5%
							</p>
						</span>
						<p className="text-sm font-inter text-[#606060] font-normal">
							vs previous month
						</p>
					</div>
				</div>
