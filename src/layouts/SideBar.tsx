...
const SideBar = ({ handleLight, handleDark, mobile }: Props) => {
	return (
		...
		>
			...
			<Link
				to="/"
				className="relative group flex justify-center mt-4 p-4 w-full cursor-pointer"
			>
				<svg
				...
				>
					<path
						...
						className="fill-[#0D062D] dark:fill-darkGray"
					/>
					<path
						opacity="0.4"
				...
				<svg
					...
					viewBox="0 0 3 21"
					fill="none"
					className="opacity-0 absolute right-0 duration-500 transition-opacity ease-in-out group-hover:opacity-100"
				>
					<path
						...
						className="fill-[#0D062D] dark:fill-gray"
					/>
				</svg>
			</Link>
			{/* trending icon */}
			...
			<ThemeButtons handleDark={handleDark} handleLight={handleLight} />

			{/* arrow-right icon */}
			<Link
				to="/"
				className="relative group flex justify-center mt-32 p-4 w-full cursor-pointer"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
			...
			<Link
				to="/"
				className="relative group flex justify-center mt-2 p-4 w-full cursor-pointer"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
